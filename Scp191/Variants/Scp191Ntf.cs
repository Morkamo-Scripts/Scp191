...
public class Scp191Ntf : Scp191Component
{
    public override uint Id { get; set; } = 9;
    public override string Name { get; set; } = "SCP-191-NTF";

    public override string Description { get; set; } = "<size=35><color=#005fed>Ты всё ещё <b>SCP-191</color></b>\n" +
