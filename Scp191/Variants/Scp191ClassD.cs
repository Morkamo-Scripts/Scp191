...
public class Scp191ClassD : Scp191Component
{
    ...
    public override string Description { get; set; } = "<b><color=#ff334b>Ты теперь <b>SCP-191 (Ребенок-киборг)</color></b>\n" +
                                                       ...
                                                       "<b>Адаптивная Защита</b> восстанавливается при полном здоровье!</color>\n" +
                                                       "<color=#0091ff>Внешние источники электричества ускоряют восстановление!</color>\n";
    ...
    private IEnumerator HintsProcessor(Player player)
    {
        ...
        RueDisplay.Get(player).Show(
            new Tag(),
            new BasicElement(310, Description), 20);
